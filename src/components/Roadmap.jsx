  ...
  return (
    <>
     <section class="roadmap" id='roadmap'>
        <h2>ShibaDino Roadmap</h2>
        <div class="roadmap_con">
            <div class="r_box">

                <img src={sc1} class="sc left1"/>
                <img src={sc2} class="sc left1"/>
                <div class="r_box_top">
                    <div class="left">
                        <img src={ellipse} />
            ...
            <div class="r_box right">
                ...
                <img src={sc3} class="sc right1"/>
                <img src={sc4} class="sc right1"/>
                <div class="r_box_top">
                    <div class="left">
                        <img src={ellipse} />
            ...
            <div class="r_box">
                <img src={sc1} class="sc left2"/>
                <img src={sc2} class="sc left2"/>
                <div class="r_box_top">
                    <div class="left">
                        <img src={ellipse} />
            ...
            <div class="r_box right">
                <img src={sc3} class="sc right2"/>
                <img src={sc4} class="sc right2"/>
                <div class="r_box_top">
                    <div class="left">
                        <img src={ellipse}/>
            ...
            <div class="r_box">
                <img src={sc1} class="sc left3"/>
                <img src={sc2} class="sc left3"/>
                <div class="r_box_top">
                    <div class="left">
                        <img src={ellipse} />
            ...
            <div class="connector">
                <img src={toright1} class="toright"/>
                <img src={toleft1} class="toleft"/>
                <img src={toright1} class="toright2"/>
                <img src={toleft1} class="toleft2"/>
